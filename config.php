...
define('STRIPE_SUCCESS_URL', 'http://localhost/W-Clsopenbox/new.html'); //Payment success URL
define('STRIPE_CANCEL_URL', 'http://localhost/W-Clsopenbox/card_data.php'); //Payment cancel URL
